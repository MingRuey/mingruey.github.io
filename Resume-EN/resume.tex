...
{\footnotesize{$\bullet$ Modeled ETF prices with ARIMA \space\space $\bullet$ Experiemted random forest classifier with traditional technical indicators like RSI, stochastic oscillator, \%R, Chaikin oscillator, CCI .etc as features}}
\vspace{-0.7\baselineskip}
