...
\usepackage[scale=0.9, top=1cm, bottom=0cm]{geometry}
...
\cvlistitem[0em]{Algorithms 4E, Robert Sedgewick and Kevin Wayne; Princeton}
\cvlistitem[0em]{Machine Learning Foundations, Hsuan-Tien Lin; NTU}
\cvlistitem[0em]{Machine Learning, Andrew Ng; Standford}
\cvlistitem[0em]{Introduction to SQL, Charles Severance; Michigan}
\cvlistitem[0em]{SQL for Data Science, Sadie St. Lawrence; UC Davis}
\vspace{-0.75\baselineskip}
